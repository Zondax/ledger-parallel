...
| Claim reward                       |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |                                                                                                                                                                                                                                                                                                                        |
...
| Set current era           |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `EraIndex`era<br/>`VecVecu8`proof<br/>                                                                          |
...
| Name          | Nano S | Nano S XL          | Nano SP/X          | Nesting | Arguments                            |
| ------------- | ------ | ------------------ | ------------------ | ------- | ------------------------------------ |
| Toggle pallet |        | :heavy_check_mark: | :heavy_check_mark: |         | `u8`pallet_idx<br/>                  |
| Toggle call   |        | :heavy_check_mark: | :heavy_check_mark: |         | `u8`pallet_idx<br/>`u8`call_idx<br/> |

## Farming

| Name                        | Nano S | Nano S XL          | Nano SP/X          | Nesting | Arguments                                                                                                                                                                  |
| --------------------------- | ------ | ------------------ | ------------------ | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Create                      |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>`BlockNumber`cool_down_duration<br/>                                                     |
| Set pool status             |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>`bool`is_active<br/>                                                                     |
| Set pool cool down duration |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>`BlockNumber`cool_down_duration<br/>                                                     |
| Reset pool unlock height    |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>                                                                                         |
| Deposit                     |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>`u128`amount<br/>                                                                        |
| Withdraw                    |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>`u128`amount<br/>                                                                        |
| Redeem                      |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>                                                                                         |
| Claim                       |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>                                                                                         |
| Dispatch reward             |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset<br/>`AssetIdOfT`reward_asset<br/>`BlockNumber`lock_duration<br/>`LookupasStaticLookupSource`payer<br/>`u128`amount<br/>`BlockNumber`reward_duration<br/> |

## XcmHelper

| Name                  | Nano S | Nano S XL          | Nano SP/X          | Nesting | Arguments                                                                        |
| --------------------- | ------ | ------------------ | ------------------ | ------- | -------------------------------------------------------------------------------- |
| Update xcm weight fee |        | :heavy_check_mark: | :heavy_check_mark: |         | `XcmCall`xcm_call<br/>`XcmWeightFeeMiscWeightBalanceOfT`xcm_weight_fee_misc<br/> |

## Streaming

| Name                | Nano S | Nano S XL          | Nano SP/X          | Nesting | Arguments                                                                                                                                       |
| ------------------- | ------ | ------------------ | ------------------ | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Create              |        | :heavy_check_mark: | :heavy_check_mark: |         | `AccountId`recipient<br/>`Balance`deposit<br/>`AssetIdOfT`asset_id<br/>`Timestamp`start_time<br/>`Timestamp`end_time<br/>`bool`cancellable<br/> |
| Cancel              |        | :heavy_check_mark: | :heavy_check_mark: |         | `StreamId`stream_id<br/>                                                                                                                        |
| Withdraw            |        | :heavy_check_mark: | :heavy_check_mark: |         | `StreamId`stream_id<br/>`Balance`amount<br/>                                                                                                    |
| Set minimum deposit |        | :heavy_check_mark: | :heavy_check_mark: |         | `AssetIdOfT`asset_id<br/>`Balance`minimum_deposit<br/>                                                                                          |
